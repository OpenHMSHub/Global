...
Select Count(schedule.dayOfYear) from (
SELECT s1.locationId, s1.scheduleId, s1.seasonId, s1.totalBeds, s1.HostLocationType, s1.gender,s1.genderId, s1.dayOfYear,s1.DateFromDayOfYear,COALESCE(sp.totalParticipants,0) as totalParticipants,
CASE 
